...
public class RLP
{
    ...
    protected static short decodeShort(byte[] data, int index) {
        if ((data[index] & 0xFF) > OFFSET_SHORT_ITEM
                && (data[index] & 0xFF) < OFFSET_LONG_ITEM) {
            byte length = (byte) (data[index] - OFFSET_SHORT_ITEM);
    ...
    protected static long decodeLong(byte[] data, int index) {
    ...
    protected static String decodeStringItem(byte[] data, int index) {
    ...
    protected static byte[] decodeItemBytes(byte[] data, int index) {
    ...
    protected static byte[] decodeByteArray(byte[] data, int index) {
    ...
    protected static int nextItemLength(byte[] data, int index) {
     ...
     */
    public static void
    fullTraverse(byte[] msgData, int level, int startPos,
