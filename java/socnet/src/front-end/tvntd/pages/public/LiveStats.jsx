...
import EasyPieChartContainer from 'vntd-shared/graphs/EasyPieChartContainer.jsx';
                ...
                <div className="row no-space">
                    <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <span className="demo-liveupdate-1">
                            <span className="onoffswitch-title">Live switch</span>
                            <span className="onoffswitch">
                                <input type="checkbox" name="start_interval" onClick={this._toggleSwitch}
                                    className="onoffswitch-checkbox" id="start_interval"/>
                                <label className="onoffswitch-label" htmlFor="start_interval">
                                    <span className="onoffswitch-inner" data-swchon-text="ON" data-swchoff-text="OFF"/>
                                    <span className="onoffswitch-switch"/>
                                </label>
                            </span>
                        </span>
                        <FlotChart className="chart-large txt-color-blue"
                            data={this.state.liveStats} options={liveStatsChartOptions}/>
                    </div>
                    <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 show-stats">
                        <div className="row">
                            <div className="col-xs-6 col-sm-6 col-md-12 col-lg-12">
                                <span className="text"> My Tasks
                                    <span className="pull-right">130/200</span>
                                </span>
                                <div className="progress">
                                    <div className="progress-bar bg-color-blueDark" style={{width: '65%'}}></div>
                                </div>
                            </div>
                            <div className="col-xs-6 col-sm-6 col-md-12 col-lg-12">
                                <span className="text"> Transfered
                                    <span className="pull-right">440 GB</span>
                                </span>
                                <div className="progress">
                            ...
                            <div className="col-xs-6 col-sm-6 col-md-12 col-lg-12">
                                <span className="text"> Bugs Squashed
                                    <span className="pull-right">77%</span>
                                </span>
                                <div className="progress">
                                    <div className="progress-bar bg-color-blue" style={{width: '77%'}}></div>
                                </div>
                            </div>
                            <div className="col-xs-6 col-sm-6 col-md-12 col-lg-12">
                                <span className="text"> User Testing
                                    <span className="pull-right">7 Days</span>
                                </span>
                                <div className="progress">
                                    <div className="progress-bar bg-color-greenLight" style={{width: '84%'}}></div>
                                </div>
                            </div>
                            <span className="show-stat-buttons">
                                <span className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <a href-void className="btn btn-default btn-block hidden-xs">Generate PDF</a>
                                </span>
                                <span className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <a href-void className="btn btn-default btn-block hidden-xs">Report a bug</a>
                                </span>
                            </span>
                        </div>
                    </div>
                </div>
                <SparklineContainer className="show-stat-microcharts" data-easy-pie-chart-container>
                    <EasyPieChartContainer>
                        <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div className="easy-pie-chart txt-color-orangeDark" data-percent="33" data-pie-size="50">
                                <span className="percent percent-sign">35</span>
                            </div>
                            <span className="easy-pie-title"> Server Load
                        ...
                        <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div className="easy-pie-chart txt-color-greenLight" data-percent="78.9" data-pie-size="50">
                                <span className="percent percent-sign">78.9 </span>
                            </div>
                            <span className="easy-pie-title"> Disk Space
                        ...
                        <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div className="easy-pie-chart txt-color-blue" data-percent="23" data-pie-size="50">
                                <span className="percent percent-sign">23 </span>
                            </div>
                            <span className="easy-pie-title"> Transfered 
                        ...
                        <div className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div className="easy-pie-chart txt-color-darken" data-percent="36" data-pie-size="50">
                                <span className="percent degree-sign">36 <i className="fa fa-caret-up"/></span>
                            </div>
                            <span className="easy-pie-title"> Temperature
                                <i className="fa fa-caret-down icon-color-good"/>
                            </span>
                            <ul className="smaller-stat hidden-sm pull-right">
                                <li>
