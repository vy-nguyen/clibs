...
class Revenue extends React.Component
{
    ...
    _getSignupsData() {
        return {
            ...
            data : [
                [1354586000000, 647], [1364587000000, 435], [1374588000000, 784],
                [1384589000000, 346], [1394590000000, 487], [1404591000000, 463],
                [1414592000000, 479], [1424593000000, 236], [1434594000000, 843],
                [1444595000000, 657], [1454596000000, 241], [1464597000000, 341]
            ],
            color : '#71843F',
            lines : {
                show : true,
                ...
                <div className="widget-body-toolbar bg-color-white smart-form" id="rev-toggles">
                    <div className="inline-group">
                        <label htmlFor="gra-0" className="checkbox">
                            <input type="checkbox" id="gra-0"
                                defaultChecked={this.props.targetsShow}
                                onClick={this._toggleProp.bind(this, 'targetsShow')}/>
                            <i/> Target
                        </label>
                        <label htmlFor="gra-1" className="checkbox">
                            <input type="checkbox" id="gra-1"
                                defaultChecked={this.props.actualsShow}
                                onClick={this._toggleProp.bind(this, 'actualsShow')}/>
                            <i/> Actual
                        </label>
                        <label htmlFor="gra-2" className="checkbox">
                            <input type="checkbox" id="gra-2"
                                defaultChecked={this.props.signupsShow}
                                onClick={this._toggleProp.bind(this, 'signupsShow')}/>
                            <i/> Signups
                        </label>
                    </div>
