    ...
    render() {
        ...
        return (
            <ul>
                ...
                <a href="#" onClick={this._openToggle}>
                    <i className="fa fa-lg fa-fw fa-comment-o">
                        <em className="bg-color-pink flash animated">!</em>
                    </i>&nbsp;<span className="menu-item-parent">Smart Chat API <sup>beta</sup></span>
                </a>
                <ul ref="chatUsersList">
                    <li>
                        <div className="display-users">
                            <input className="form-control chat-user-filter"
                                placeholder="Filter" type="text" valueLink={this.linkState('filter')}/>
                                <dl>{
